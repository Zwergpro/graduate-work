...
def get_sort_func(appts, a_index):
    def _sort_func(doctor_id):
        ...
        return np.array(dists).min() if dists else 0
...
# angular 53.805055816957285 36.30538976035512   - sum
# angular 53.805055816957285 36.30538976035512   - mean
# angular 53.805055816957285 36.61189920812102   - min
